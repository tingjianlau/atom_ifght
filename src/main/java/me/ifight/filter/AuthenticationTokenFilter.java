...
/**
 * @description: 解析token的过滤器
 * 配置在 Spring Security 的配置类中
 * 用于解析 token ，将用户所有的权限写入本次 Spring Security 的会话中
 * @author: tjliu
 * @create: 2019-01-06 12:07
 **/
public class AuthenticationTokenFilter extends UsernamePasswordAuthenticationFilter {
    private static final Logger loger = LoggerFactory.getLogger(AuthenticationTokenFilter.class);
    /**
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (this.tokenUtils.validateToken(authToken, userDetails)) {
                ...
                logger.info("Authencicate success!");
            }
